        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter =
                new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull AdminOrdersViewHolder adminOrdersViewHolder, final int i, @NonNull final AdminOrders adminOrders) {
                        ...
                        adminOrdersViewHolder.userPhoneNumber.setText("Teléfono: " + adminOrders.getPhone());
                        adminOrdersViewHolder.userTotalPrice.setText("Precio Total: " + adminOrders.getTotalAmount());
                        adminOrdersViewHolder.userDateTime.setText("Order a las: " + adminOrders.getDate() + " " + adminOrders.getTime());
                        adminOrdersViewHolder.userShippingAddress.setText("Dirección de envío: " + adminOrders.getAddress() + ", " + adminOrders.getCity());
                        ...
                        adminOrdersViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setTitle("¿Has enviado este pedido de productos?");
