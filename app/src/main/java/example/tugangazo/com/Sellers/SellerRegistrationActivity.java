...
public class SellerRegistrationActivity extends AppCompatActivity {
    ...
    private void RegisterSeller() {
        ...
        if (!name.equals("") && !phone.equals("") && !email.equals("") && !password.equals("") && !address.equals("")){
            ...
            loadingBar.setTitle("Creando tienda");
                                ...
                                rootRef.child("Sellers").child(sid).updateChildren(sellerMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                loadingBar.dismiss();
                                                Toast.makeText(SellerRegistrationActivity.this, "Tu tienda ha sido registrada satisfactoriamente.", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Por favor completa el formulario de registro.", Toast.LENGTH_SHORT).show();
        }
